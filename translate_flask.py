...
def analyze_text(from_lang_text):
    text_analytics_client = authenticate_text_analytics()
    result = text_analytics_client.recognize_entities(documents=[from_lang_text])[0]
...
def index():
    if ('listen' in request.form):
        ...
        global duration
        global entities
        return render_template("result.html", from_lang=from_lang,to_lang=to_lang,from_lang_text=from_lang_text,to_lang_text=to_lang_text,duration=duration,entities=entities)
        ...
        entities = analyze_text(from_lang_text)
        return render_template("result.html", from_lang=from_lang,to_lang=to_lang,from_lang_text=from_lang_text,to_lang_text=to_lang_text,duration=duration,entities=entities)
